...
function FileTab({ file, isActive, onSelect, onClose }: FileTabProps) {
  ...
  return (
    // AIDEV-NOTE: Using div with role="tab" instead of button to avoid nested buttons issue.
    // The close button is a separate interactive element inside.
    <div
      role="tab"
      tabIndex={0}
      onClick={onSelect}
      ...
      className={cn(
        'group flex items-center gap-2 px-3 py-1.5 text-sm border-r border-border cursor-pointer',
