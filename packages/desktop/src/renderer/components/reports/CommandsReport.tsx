...
export function CommandsReport({
	...
	const [sortColumn, setSortColumn] =
		useState<keyof CommandReportRow>("command");
		...
		<div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
			...
			<div
				className={cn(
					...
					"w-[800px] max-w-[90vw] h-[80vh] flex flex-col",
            ...
            The inner div with relative positioning isolates the table layout. */}
